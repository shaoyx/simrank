...
void TopSimFamily::run(int qv, int k){
    ...
    timer.start();
    switch(type){
    	case 1: topsim_sm(qv, k); break;
    	case 2: trun_topsim_sm(qv, k); break;
    	case 3: prio_topsim_sm(qv, k); break;
    	default: printf("Not supported type %d of topsim. [valid ones: 1, 2, 3.]\n", type);
    }
    timer.stop();
